...
__decorate([
    (0, typeorm_1.Column)({ comment: '是否置頂聊天', type: 'boolean', default: false }),
    __metadata("design:type", Boolean)
], ChatGroupEntity.prototype, "isSticky", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '分組名稱', nullable: true }),
    __metadata("design:type", String)
], ChatGroupEntity.prototype, "title", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '應用ID', nullable: true }),
    __metadata("design:type", Number)
], ChatGroupEntity.prototype, "appId", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '是否刪除了', default: false }),
    __metadata("design:type", Boolean)
...
__decorate([
    (0, typeorm_1.Column)({ comment: '附加參數', nullable: true, type: 'text' }),
    __metadata("design:type", String)
], ChatGroupEntity.prototype, "params", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '文件鏈接', nullable: true, default: null, type: 'text' }),
    __metadata("design:type", String)
], ChatGroupEntity.prototype, "fileUrl", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: 'PDF中的文字內容', nullable: true, type: 'mediumtext' }),
    __metadata("design:type", String)
