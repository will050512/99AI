...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'hello, Who are you', description: '對話資訊' }),
    (0, class_validator_1.IsNotEmpty)({ message: '提問資訊不能為空！' }),
    __metadata("design:type", String)
], ChatProcessDto.prototype, "prompt", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'https://aiweb.com', description: '對話附帶的鏈接', required: false }),
    __metadata("design:type", String)
], ChatProcessDto.prototype, "url", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '{ parentMessageId: 0 }', description: '上次對話資訊', required: false }),
